...
function isGithubAlertType(value: unknown): value is GithubAlertType {
  return typeof value === "string" && (githubAlertTypes as readonly string[]).includes(value);
}
...
function parseGithubAlertBlockquote(node: Readonly<BlockquoteNode>): GithubAlert | null {
